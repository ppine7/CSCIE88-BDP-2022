...
# this is a very simple multi-processing application that uses
# inter-process Manager.Value for shared state ...

import argparse
import multiprocessing
from multiprocessing import Lock

prog = "counter_process_mem"
desc = "run specified number of threads - use counter from process space"
